        ...
        >
          ...
          {isTermsAccepted && (
            <div>
              ...
              <button
                onClick={async () => {
                  if (!canProceedToPayment() || paymentLoading) return;
                ...
                className={`w-full px-8 py-3 rounded-full font-semibold shadow-sm transition-colors inline-flex items-center justify-center gap-2 ${
                  canProceedToPayment() && !paymentLoading
                    ? "bg-blue-700 text-white hover:bg-blue-800 cursor-pointer"
                    : "bg-gray-300 text-gray-500 cursor-not-allowed"
                }`}
              >
